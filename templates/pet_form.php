                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <div class="form-check mt-4 pt-2">
                            <input class="form-check-input" type="checkbox" id="neutered" name="neutered" 
                                   value="1" <?= ($formData['neutered'] ?? false) ? 'checked' : '' ?>>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control" id="date_of_birth" name="date_of_birth" 
                               value="<?= htmlspecialchars($formData['date_of_birth'] ?? '') ?>" max="<?= date('Y-m-d') ?>">
                    </div>
    ...
    <div class="col-md-4">
        <div class="card mb-4">
            ...
            <div class="card-body text-center">
                <div class="mb-3">
                    <img id="profile-picture-preview" src="<?= htmlspecialchars('assets/images/default-pet.jpg') ?>" 
...
<script src="assets/js/pet_form.js"></script>
